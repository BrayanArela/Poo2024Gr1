...
//MsgBox msgBox = new MsgBox("Hola manolo", JOptionPane.ERROR_MESSAGE, "img/secrecy-icon.png");
MsgBox msgBox = new MsgBox("Mensaje", JOptionPane.ERROR_MESSAGE, "img/store.png");
}
}
